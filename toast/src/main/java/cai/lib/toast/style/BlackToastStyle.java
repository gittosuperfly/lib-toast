...
import cai.lib.toast.define.IToastStyle;
...
public class BlackToastStyle implements IToastStyle<TextView> {
    ...
    public TextView createView(Context context) {
        ...
        textView.setY(getTranslationY(context));
        return textView;
    }
    ...
    protected float getTextSize(Context context) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 12, context.getResources().getDisplayMetrics());
    }
    ...
    protected float getTranslationY(Context context) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, context.getResources().getDisplayMetrics());
    }
